...
## using graphkernels in python https://github.com/BorgwardtLab/graph-kernels
...
# cd ~/Workspace/GraphKernels/Tutorial
# data_mutag = np.load('data.mutag', allow_pickle=True)
# data_mutag[0]



##todo: try differnt kernels from GraKeL https://github.com/ysig/GraKeL
